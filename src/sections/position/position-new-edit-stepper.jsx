...
function PositionCreateStepper() {
  ...
  useEffect(() => {
    fetch('http://54.180.76.116:8080/boch/create/position')
      .then((response) => response.json())
      .then((data) => setCurrentPosition(data));
  }, []);
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      {activeStep === steps.length ? (
        ...
        <>
          <PositionNewEditForm currentPosition={currentPosition} step={activeStep} />
