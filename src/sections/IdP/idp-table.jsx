...
import IDPTableToolbar from './idp-table-toolbar';
import IDPTableFiltersResult from './idp-table-filters-result';
...
export default function IDPTable({ data, TABLE_HEAD, columns, selected}) {
          ...
          {cellData.map((item, index) => (
            <Fragment key={index}>
              <Label
                ...
                variant="soft"
                color={
                  (item.type === 'client' && 'success') ||
                  (item.type === 'realm' && 'info') ||
                  'default'
                }
              >
                {item.name}
